function [y_numeric,y_exact] = sample_rk2(tspan, y0, h)
...
% The numerical solution y_numeric is found by using the second order Runge-Kutta method.
% The exact solution for this example with y0=2 is y_exact = (t^2 + t + 4)^(1/2)

[t, y_numeric] = rk2('yprime', tspan, y0, h); % the Runge-Kutta method
